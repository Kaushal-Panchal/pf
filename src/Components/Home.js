...
const Home = () => {
    ...
    return (
        <>
            <div
                id="home"
                className="flex sm:flex-row flex-col-reverse h-screen justify-end items-center pt-10"
            >
                    ...
                    >
                        ...
                        >
                            <p className="leading-loose">
                                ...
                                <span className="text-4xl font-thin italic text-pink-600">
                                    &
                                </span>{" "}
                                <br /> I love to work on real life problems and
